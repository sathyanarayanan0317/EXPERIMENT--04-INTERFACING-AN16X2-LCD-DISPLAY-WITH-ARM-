...
int main(void)
{
  ...
  Lcd_cursor(&lcd, 0,1);
  Lcd_string(&lcd, "Sanjay kumar B");
  Lcd_cursor(&lcd, 1,1);
  Lcd_string(&lcd, "212224230242");
...
<img width="1594" height="987" alt="exp4pmc" src="https://github.com/user-attachments/assets/2037cdbc-01dd-44c7-9efe-bde398a522b1" />


 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
 <img width="444" height="407" alt="image" src="https://github.com/user-attachments/assets/93121d2e-66f2-4c8d-a594-dd694815c195" />
